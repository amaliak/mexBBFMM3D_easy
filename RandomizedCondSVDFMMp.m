function [U,S,V] = RandomizedCondSVDFMMp(grid,Kernel,Corlength,Corlengthz,N,a)
...
% matrix H is split in submatrices depending on how many processors are
% available, and then the QH matrix is constucted by assembling the
